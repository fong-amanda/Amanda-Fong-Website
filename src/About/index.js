      ...
      <section id="aboutMe" className="aboutMe">
          ...
          <div className="aboutMeText">
            ...
            >
              ...
              <span style={{ color: "green" }}>
                create a digital world that welcomes and empowers all users.
              </span>{" "}
              In my free time, you can find me digitally painting, scrapbooking,
              doing puzzles, trying new brunch places, or reading!
            </p>
            <div></div>

            <div
              className={`fade-in links ${contactVisible ? "visible" : ""}`}
              ref={contactRef}
            >
              ...
              <h3>
                <a
                  href="https://www.linkedin.com/in/amanda-fong-217a04260/"
                  target="_blank"
                  rel="noopener noreferrer"
                >
              ...
              <h3>
                <a
                  href="https://github.com/fong-amanda"
                  target="_blank"
                  rel="noopener noreferrer"
                >
        ...
        <div className="moreAbout">
          <div className="skills" ref={skillsRef}>
            ...
            <h5>Tools & Frame:</h5>
            <p className={`fade-in ${skillsVisible ? "visible" : ""}`}>
              Eclipse | Intellij | React | Bootstrap | Visual Studio | Microsoft
              Office Suite | Adobe Illustrator | Adobe Photoshop | Adobe
              InDesign | Figma | Axure | Procreate | Mailchimp | Adobe After
              Effects | Adobe Premiere | AutoCAD | Balsamiq
            </p>
          </div>
          <div className="extracirriculars" ref={extracurricularsRef}>
            ...
            <p
              className={`fade-in ${extracurricularsVisible ? "visible" : ""}`}
            >
              ✧ Design Producer | Prev. Design Lead + Prev. Developer @{" "}
              <a
            ...
            >
              ✧ Media Specialist @{" "}
              <a
                href="https://www.instagram.com/nu_tasa/"
                target="_blank"
                rel="noreferrer"
              >
            ...
            >
              ✧ Marketing Designer @{" "}
              <a
                href="https://www.freetelehealth.org/"
                target="_blank"
                rel="noreferrer"
              >
                Hermes Telehealth
