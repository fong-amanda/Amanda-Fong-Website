...
function FixLeakProcess() {
  return (
    <CaseStudyLayout>
      <CaseCover src="fixALeak Images/Cover2Landscape.jpg" alt="Cover" />
      ...
      <CaseOverview
        overview="People often don’t know who to contact when they approach a mechanical issue in the building. They likely don’t say anything or they contact the wrong person. The goal of this project was to develop an app that would allow residents to easily report any mechanical issues they encountered in a building. To start the human-centered design and evaluation process, we conducted interviews with some representative users. We gathered their valuable insight and feedback through a Google form we created and sent to them. These responses from our users were used to better understand their needs and expectations associated with such building issues before sketching out and prototyping UIs. Following design iteration, evaluation, and revisions, we ultimately arrived at a final design. This report outlines the app's design process and presents the specifics of our evaluation, including results and recommendations for future enhancements."
        links={[
          {
            label: "High-Fidelity Prototype",
            href: "https://ihlp9w.axshare.com/?id=h5upi9&p=intro",
          },
        ]}
        role="UI/UX Designer"
        team="Amanda Fong, Benjamin Kataoka, Keelan Donovan, Matthew Li"
      ...
      <CaseBody className="leak">
        ...
        <CaseImage src="fixALeak Images/audrey.png" alt="Persona" />
        <CaseImage src="fixALeak Images/affinity diagram.png" alt="Affinity Diagram" />
        <CaseImage src="fixALeak Images/notes.png" alt="Notes" />
        ...
        <p>We created rough sketches for our prototype. We decided that to generate our wireframes, we would look at
          ...
          work
          off of.</p>
        <CaseImage src="fixALeak Images/ideationPhase.png" alt="ideation phase" />
        ...
        <CaseImage src="fixALeak Images/paperSketch1.png" alt="paper sketch" />
        <CaseImage src="fixALeak Images/paperSketch2.png" alt="paper sketch" />
        ...
        <CaseImage src="fixALeak Images/LF2.png" alt="Low-fidelity2" />

        <h5>Engineer Interfaces</h5>
        <CaseImage src="fixALeak Images/LF3.png" alt="Low-fidelity3" />
        <h4>Mid-Fidelity Wireframes</h4>
        <h5>Resident Interfaces</h5>
        <CaseImage src="fixALeak Images/MF1.png" alt="Medium-fidelity1" />
        ...
        <h5>Resident Interfaces</h5>
        <CaseImage src="fixALeak Images/residentInterface.png" alt="Resident Interface" />
        ...
        <CaseImage src="fixALeak Images/taskCompletionRates.png" alt="Task Completion Rates" />
        <h3>Time on Task</h3>
        ...
        <CaseImage src="fixALeak Images/timeOnTask.png" alt="Time On Task" />
        ...
        <CaseImage src="fixALeak Images/taskBasedUsability.png" alt="Task-Based Usability" />
