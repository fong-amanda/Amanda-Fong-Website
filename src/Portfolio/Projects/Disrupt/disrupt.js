...
function DisruptProcess() {
  return (
    <CaseStudyLayout>
      <CaseCover
        src="disruptImages/disruptLandscape.jpg"
        alt="Disrupt Landscape"
      />
      ...
      <CaseOverview
        ...
        links={[
          ...
          { label: "Deployed Site", href: "https://www.disruptneu.com/" },
          {
            label: "Brand Book",
        ...
        role="UI/UX Designer"
        team={[
          { role: "Project Lead:", people: "Preet Singh" },
          { role: "Design Lead:", people: "Jyaleen Wu" },
          { role: "Designers:", people: "Lucas Clavijo, Amanda Fong" },
          { role: "Tech Lead:", people: "Brian Kapusta" },
          { role: "Developer:", people: "Helen Miao" },
        ]}
      ...
      <CaseBody className="disrupt">
        ...
        <div className="lightbox-images flex-images">
          <CaseImage src="disruptImages/moodboarding.jpg" alt="Moodboard" />
          <CaseImage src="disruptImages/moodboarding2.jpg" alt="Moodboard" />
          <CaseImage src="disruptImages/moodboarding3.jpg" alt="Moodboard" />
        </div>
        ...
        <CaseImage src="disruptImages/lofis.png" alt="lo-fi" />
        <br />
        <CaseImage src="disruptImages/lofis2.png" alt="lo-fi" />
        <h3>Logo Iteration</h3>
        <CaseImage src="disruptImages/logo1.png" alt="logo iterations" />
        <br />
        ...
        <div className="two-columns-container">
          <div className="column">
            <CaseImage src="disruptImages/colorScheme.png" alt="color scheme" />
          </div>
        ...
        <div className="two-columns-container">
          <div className="column">
            <CaseImage src="disruptImages/type1.png" alt="type" />
          </div>
          <div className="column disrupt">
            <CaseImage src="disruptImages/type2.png" alt="type" />
          </div>
        </div>
        <br />
        ...
        <div className="two-columns-container">
          <div className="column">
            ...
            <CaseImage src="disruptImages/finallogo.png" alt="final logo" />
          </div>
          <div className="column disrupt">
            <h4>Exclusion Zones</h4>
            <CaseImage src="disruptImages/logofinal1.png" alt="final logo" />
          </div>
        </div>
        <br />
        ...
        <br />
        <CaseImage src="disruptImages/lofi2.png" alt="lo-fi" />
        <br />
        <CaseImage src="disruptImages/lofi3.png" alt="lo-fi" />
        <br />
        <h3>Mid-Fidelity Wireframes</h3>
        <CaseImage src="disruptImages/midfi1.png" alt="mid-fi" />
        <br />
        <CaseImage src="disruptImages/midfi2.png" alt="mid-fi" />
        <br />
        <CaseImage src="disruptImages/midfi3.png" alt="mid-fi" />
        ...
        <CaseImage src="disruptImages/hifiHomeAbout.png" alt="hi-fi" />
        <br />
        <h4>Venture Pages</h4>
        <CaseImage src="disruptImages/hifiVentures.png" alt="hi-fi" />
        <br />
