      ...
      <section className="summary wanderly">
        ...
        <ul>
          ...
          <li>
            ...
            - Male 22 year old (Social Traveller + Documenter)
          </li>
          <li>
        ...
        <br />
        <div class="container-wanderly">
          <div class="column-wanderly">
            <div class="number">1</div>
            <div class="title">Travel-documenters</div>
          ...
          <div class="column-wanderly">
            ...
            <div class="title">Social Travelers</div>
            <div class="divider"></div>
            <p>
              <strong>Pain Points:</strong>
            </p>
          ...
          <div class="column-wanderly">
            ...
            <div class="title">Travel Planners</div>
            <div class="divider"></div>
            <p>
              <strong>Pain Points:</strong>
            </p>
        ...
        <div class="container-wanderly">
          <div class="column-wanderly">
            <div class="title">Travel-documenter</div>
            <div class="divider"></div>
        ...
        <div class="analysis-container">
          <div class="comparison-table">
            ...
            <div class="table-header">User Story</div>
            <div class="table-header">App 1</div>
            <div class="table-header">App 2</div>
            <div class="table-header">App 3</div>
            <div class="workflow-group">
              <div class="workflow-cell">
                Workflow 1: <br />
                Saving posts/videos to collection
              </div>
              <div class="user-story-cell">
...
<div class="app-takeaway">
              ...
              <div class="app-cell">
                <div class="app-name">Photos App</div>
<div class="app-takeaway">
                  <ul>
              ...
              <div class="app-cell">
                <div class="app-name">Pic Collage</div>
<div class="app-takeaway">
                  <ul>
...
<div class="app-takeaway">
        ...
        <div class="overall-takeaways-section">
          <h4>Overall Takeaways</h4>
          <div class="takeaways-grid">
            <div class="takeaway-item">
              <div class="takeaway-title">Workflow 1: Saving posts/videos</div>
          ...
          <h2>4 | Color Palette + Typeography</h2>
